...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className = '', variant = 'primary', size = 'md', isLoading, icon, fullWidth, children, disabled, ...props }, ref) => {
        ...
        // Only append variant class if it's NOT icon, because btn-icon handles it all.
        // Actually, btn-icon matches .btn-icon in css.
        // But for others, it's btn btn-primary etc.
