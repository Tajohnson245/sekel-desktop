/**
 * nbme-ambulatory-care-shelf-v2025.ts — Seed Ambulatory Care Subject Exam blueprint into Supabase.
 *
 * Source: NBME Ambulatory Care Subject Exam Content Outline, Clinical Science.
 * https://www.nbme.org/subject-exams/clinical-science/ambulatory-care
 *
 * Run via:
 *   npx tsx scripts/seed-blueprints-supabase.ts --exam ambulatory-care-shelf
 *
...
upsertBlueprint({
    ...
    systems: [
        ...
        { system_key: 'skin-subcutaneous',             label: 'Skin & Subcutaneous Tissue',                                                                             weight_min: 5,  weight_max: 10 },
        ...
        { system_key: 'renal-urinary',                 label: 'Renal & Urinary System',                                                                                 weight_min: 3,  weight_max: 8  },
        ...
        { system_key: 'endocrine',                     label: 'Endocrine System',                                                                                        weight_min: 8,  weight_max: 12 },
        { system_key: 'multisystem',                   label: 'Multisystem Processes & Disorders',                                                                      weight_min: 5,  weight_max: 10 },
        { system_key: 'biostatistics-epidemiology',    label: 'Biostatistics, Epidemiology/Population Health, & Interpretation of the Medical Literature',             weight_min: 3,  weight_max: 8  },
        { system_key: 'social-sciences',               label: 'Social Sciences, Including Medical Ethics, Jurisprudence, and Systems-Based Practice and Patient Safety', weight_min: 1, weight_max: 5  },
    ],
}).catch((err) => {
